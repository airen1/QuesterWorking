...
namespace WowAI.Module
{
    internal partial class FarmModule
    {
        ...
        public int MobsWithDropCountNoIgnore()
        {
            var result = 0;
            try
            {
                ...
                foreach (var unit in mobsWithDropLoot.OrderBy(i => Host.Me.Distance(i)))
                {
                    ...
                    if (Host.CanPickupLoot())
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if (unit.Id == 7318 && Host.MyGetItem(8149) != null)
                                {
                                    var item = Host.MyGetItem(8149);
                                    if (item != null)
                                    {
                            ...
                            {
                                if (Host.AutoQuests.BestQuestId == 13523 && unit.Id == 32890)
                                {
                                ...
                                if (Host.AutoQuests.BestQuestId == 13576 && unit.Id == 32999)
                                {
                                ...
                                if (Host.AutoQuests.BestQuestId == 49666 && unit.Id == 134560)
                                {
                                ...
                                if (Host.AutoQuests.BestQuestId == 49666 && unit.Id == 134558)
                                {
                                    var item = Host.MyGetItem(158884);
                                    if (item != null)
                                    {
                                ...
                                if (Host.AutoQuests.BestQuestId == 48573 && unit.Id == 126723)
                                {
                                ...
                                {
                                    if (Host.AutoQuests.BestQuestId == 47577)
                                    {
                    ...
                    else
                    {
                        ...
                        if (MobsWithDropCount() == 1)
                        {
                            ...
                            Host.SetVar(unit, "pickFailed", true);
                            if (MobsWithDropCount() == 0 && MobsWithDropCountNoIgnore() > 5)
                            {
                                Host.MySendKeyEsc();
                            }
                        }
