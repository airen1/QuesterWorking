...
namespace WowAI
{
    internal partial class MyQuestHelpClass
    {
        public List<MyQuest> Quest112OrcTrollWarrior = new List<MyQuest>
        {
            ...
            new MyQuest(QuestAction.UseHs, 813, new Vector3F(-436.9, -3176, 0)),
            ...
            new MyQuest(QuestAction.UseHs, 840, new Vector3F(272.6, -4651.4, 0)),
            ...
            new MyQuest(QuestAction.SetHs, 844, new Vector3F(-406.9, -2645.5, 0)),
            new MyQuest(1492, QuestAction.Apply, ERace.None, EClass.None),
            new MyQuest(848, QuestAction.Apply, ERace.None, EClass.None),
            new MyQuest(QuestAction.GetFp, 924, new Vector3F(-436.3, -2595.7, 0)),
